    ...
    <div class="form-group">
     {{-- data-toggle="modal" data-target="#category_choosing_modal"> --}}
        ...
        <div id="category_chosen_div">
            <div class="col-xs-4">
                <p class="col-xs-10" id="category_chosen_id">{{$transaction->category->title}} &nbsp;&nbsp;</p>
                <span class="col-xs-2 {{$transaction->category->logo->class_name}}" style="font-size:30px"></span>
    ...
    @if($transaction->repeat->type !='fixed')
        ...
        @if($transaction->repeat->type !='fixed')
            <div class="form-group edit_info">
                <div class="col-xs-4 col-xs-offset-4 custom-control custom-radio">
...
<p class="text-center text-info">Also, you can not edit an already done transaction</p>
