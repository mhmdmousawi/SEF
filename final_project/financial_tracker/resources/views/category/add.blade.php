...
<form id="add_saving_form"  class="form-horizontal" action="{{config('app.url')}}/add/category" method="POST">
    ...
    <div class="form-group">
        <label class="control-label col-xs-4 text-primary" for="type">Type:</label>
        <div class="col-xs-4">
    ...
    <div class="form-group" data-toggle="modal" data-target="#logo_choosing_modal">
        <label class="control-label col-xs-4 text-primary" for="category">Logo:</label>
        <div class="col-xs-3">
            <p class="col-xs-12 text-info" id="logo_chosen_id">Click to choose your logo  &nbsp;&nbsp;</p>
        </div>
        <div id="logo_chosen_div" class="col-xs-5">
