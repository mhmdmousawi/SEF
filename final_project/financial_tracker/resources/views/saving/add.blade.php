...
<form id="add_saving_form">
    ...
    Amount per fequency: <input id='amount' name='amount' placeholder="Amount"/>
    ...
    <input id="verify_bnt" type="button" data-toggle="modal" data-target="#saving_varification_modal" value="Verify">
</form>
